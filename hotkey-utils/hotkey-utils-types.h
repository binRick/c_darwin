...
//////////////////////////////////////
const cyaml_schema_field_t appposition_fields_schema[] = {
  CYAML_FIELD_STRING_PTR("app",  CYAML_FLAG_POINTER, struct hk_appposition_t, app,      0, CYAML_UNLIMITED),
  CYAML_FIELD_STRING_PTR("side", CYAML_FLAG_POINTER, struct hk_appposition_t, side,     0, CYAML_UNLIMITED),
  CYAML_FIELD_FLOAT("size",      CYAML_FLAG_DEFAULT, struct hk_appposition_t, size),
  CYAML_FIELD_BOOL("enabled",    CYAML_FLAG_DEFAULT, struct hk_appposition_t, enabled),
  CYAML_FIELD_END,
};
const cyaml_schema_value_t appposition_schema = {
  CYAML_VALUE_MAPPING(CYAML_FLAG_DEFAULT, struct hk_appposition_t, appposition_fields_schema),
};
...
const cyaml_schema_field_t layout_fields_schema[] = {
  ...
  CYAML_FIELD_ENUM("gravity",      CYAML_FLAG_DEFAULT, struct hk_layout_t, gravity,        gravity_type_strings, CYAML_ARRAY_LEN(gravity_type_strings)),
  CYAML_FIELD_FLOAT("size",        CYAML_FLAG_DEFAULT, struct hk_layout_t, size),
...
//  CYAML_FIELD_SEQUENCE("apppositions", CYAML_FLAG_POINTER, struct hotkeys_config_t, apppositions, &appposition_schema, 0,               CYAML_UNLIMITED),
  CYAML_FIELD_END,
};
